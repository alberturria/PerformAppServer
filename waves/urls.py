...
urlpatterns = [
    ...
    url(r'^(?P<user_id>\d+)/wave-statistics/(?P<suite_id>\d+)$', WaveStatisticsView.as_view(), name='wave_statistics_view'),
    ...
    url(r'^(?P<user_id>\d+)/diagnoses-sample-data$', DiagnosesSampleDataView.as_view(), name='diagnoses_sample_data_view'),
